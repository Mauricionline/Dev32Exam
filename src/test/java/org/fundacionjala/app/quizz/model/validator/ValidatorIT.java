...
public class ValidatorIT {
    ...
    public void testDateValidatorError() {
        ...
        dateValidator.validate("a24/12/2021", null, errors);
    ...
    public void testMaxLengthValidator() {
        ...
        maxLengthValidator.validate("1234567890", "10", errors);
    ...
    public void testMinLengthValidator() {
        ...
        minLengthValidator.validate("1234", "3", errors);
    ...
    public void testMinLengthValidatorError() {
        ...
        minLengthValidator.validate("12", "3", errors);
    ...
    public void testOnlyUpperValidatorErrorWithNumbers() {
        ...
        validator.validate("ASDFASDF1234",null, errors);
